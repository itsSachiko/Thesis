...
{
    /// <summary>
    /// this class is responsible for saving and loading the graph data to and from a DialogueContainer ScriptableObject. 
    /// It handles the serialization of nodes, edges, exposed properties, and comment blocks, allowing for persistent storage of the graph's state.
    /// </summary>
    public class GraphSaveUtility
    {
        ...
        private void GenerateDialogueNodes()
        {
            ...
            {
                var tempNode = _graphView.CreateNode(perNode.DialogueText, perNode.ActorText, Vector2.zero);
