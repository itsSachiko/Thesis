...
{
    /// <summary>
    /// this class is responsible for parsing the dialogue data and displaying it in the UI. 
    /// It handles the dialogue flow, including choices and navigation between dialogue nodes.
    /// </summary>
